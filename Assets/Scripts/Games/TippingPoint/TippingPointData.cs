...
/// <summary>
/// Contains general Game data for the TippingPoint gametype.
/// </summary>
public class TippingPointData : GameData
{
	const string ATTRIBUTE_GUESS_TIMELIMIT = "guessTimeLimit";
	const string ATTRIBUTE_RESPONSE_TIMELIMIT = "responseTimeLimit";
	public const string ATTRIBUTE_SIDE = "side";
	...
	public TippingPointData(XmlElement elem) 
		: base(elem)
	{
	}
